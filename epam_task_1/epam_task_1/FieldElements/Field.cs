...
namespace epam_task_1.FieldElements
{
    public class Field
    {
        ...
        public Field()
        {
            field[1, 0] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.Black.ToString(), true);
            field[1, 1] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.Black.ToString(), true);
            field[1, 2] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.Black.ToString(), true);
            field[1, 3] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.Black.ToString(), true);
            field[1, 4] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.Black.ToString(), true);
            field[1, 5] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.Black.ToString(), true);
            field[1, 6] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.Black.ToString(), true);
            field[1, 7] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.Black.ToString(), true);

            field[6, 0] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.White.ToString(), true);
            field[6, 1] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.White.ToString(), true);
            field[6, 2] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.White.ToString(), true);
            field[6, 3] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.White.ToString(), true);
            field[6, 4] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.White.ToString(), true);
            field[6, 5] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.White.ToString(), true);
            field[6, 6] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.White.ToString(), true);
            field[6, 7] = new Pawn(NameEnum.Pawn.ToString(), ColorEnum.White.ToString(), true);
